...
enum color_palette { PRIMARY_PALETTE, SECONDARY_PALETTE, TERTIARY_PALETTE, RANDOM_PALETTE, MONOCHROMATIC_PALETTE, COMPLEMENTARY_PALETTE, SPLIT_COMPLEMENTARY_PALETTE, TRIAD_PALETTE, TETRAD_PALETTE, SQUARE_PALETTE, DEFAULT_COLOR_PALETTE
};
