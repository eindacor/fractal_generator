...
void fractal_generator::generateFractalWithRefresh(const int &num_points, const int &transformation_refresh)
{
	generateFractalWithRefresh(mc.getRandomVec4(), num_points, transformation_refresh);
}
